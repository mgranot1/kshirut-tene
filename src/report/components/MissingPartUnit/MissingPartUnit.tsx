...
import { MAX_LENGTH_DESCRIPTION } from "../../pages/FaultHhEmz/FaultHhEmz";
import { IHHErr } from "../../types/hh.types";
import DropDownInput from "../DropDownInput/DropDownInput";
import "./MissingPartUnit.scss";
    ...
    <div className="missingPart ">
      ...
      <div className="missingPart__bottom">
        ...
        <div className="missingPart__sum">
          ...
          <input
            type="number"
            className="missingPart_number"
            value={unit.quantity}
            min="1"
            onChange={(e) => {
              const value = e.target.value;
              const isValidInteger = /^\d+$/.test(value);
              const numValue = isValidInteger ? Number(value) : 1;
              const clampedValue = Math.max(1, numValue);
              setMissingPartField(clampedValue, "quantity");
            }}
          />
          <button
            className="missingPart__btn"
